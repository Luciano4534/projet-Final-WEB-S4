...
<body>
    ...
    <div class="container">
        ...
        <form action="/types-operations/store" method="POST" class="mt-3" style="max-width: 600px;">
            <?= csrf_field() ?>

            <div class="mb-3">
                <label for="libelle" class="form-label">Libellé</label>
                <input type="text" class="form-control" id="libelle" name="libelle" required
                       maxlength="100" placeholder="Ex: Dépôt, Retrait, Transfert"
                       value="<?= old('libelle') ?>">
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="description" name="description" rows="3"
                          placeholder="Description du type d'opération..."><?= old('description') ?></textarea>
            </div>
