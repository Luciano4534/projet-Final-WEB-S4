...
<body>
    ...
    <div class="container">
        ...
        <form action="/types-operations/update/<?= $typeOp->id ?>" method="POST" class="mt-3" style="max-width: 600px;">
            <?= csrf_field() ?>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="libelle" name="libelle" required
                       maxlength="100"
                       value="<?= esc($typeOp->libelle) ?>">
            </div>

            <div class="mb-3">
                <label for="description" class="form-label">Description</label>
                <textarea class="form-control" id="description" name="description" rows="3"><?= esc($typeOp->description) ?></textarea>
            </div>

            <button type="submit" class="btn btn-warning">Modifier</button>
            <a href="/types-operations" class="btn btn-secondary">Annuler</a>
        </form>
    </div>
